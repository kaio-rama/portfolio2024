---
title: 'Visual Loosers: generador de visuales con GLSL - Manual Español'
publishedAt: '2024-08-28'
summary: 'Aprende a usar Visual Loosers con pocos conocimientos de GLSL.'
---

Prueba VisualLoosers <a href="https://kaio-rama.github.io/visualsloosers/" target="blank" style={{color: 'blue'}}>https://kaio-rama.github.io/visualsloosers/</a>

### ¿Que es Visual Loosers?

Basicamente es un generador de visuales a partir de código GLSL. Esto quiere decir que cuando entres en la página veras un editor de texto en donde
podrás escribir código y este se renderizara cuando toques el botón "Ejecutar código".
Este código sera ejecutado en el Canvas que forma el display del resto de la aplicación. ¿Simple no?
Puedes empezar a ver resultados con el botón Random, el cual te "genera" códigos aleatorios (ya preestablecidos generados con IA) para que puedas empezar
a familiarizarte con la interfaz de la aplicación.

VisualLoosers está escrito en JavaScript e implementa WebGL a traves de p5.js.

Crado por Ramiro Canevari (a.k.a kaio-rama)
